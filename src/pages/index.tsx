		...
		<div className="flex flex-col h-screen justify-between mb-auto">
			...
			<div className="bg-blue-50 py-6">
				<div className="max-w-2xl mx-auto">
					...
					<ul className="grid grid-cols-2 gap-4 mb-7 mt-4">
						{categories.map((category) => (
							...
							>
								<li
									key={category.ID}
									className="font-bold border px-6 py-4 rounded-md hover:bg-gray-100 transition duration-100 hover:shadow-xm bg-white"
								>
